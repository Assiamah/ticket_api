...
public class cls_corporate_portal_sub_users {
	...
	public String select_corporate_portal_sub_users_all_by_org(String json_request) {
		String result = null;
		String SQL = "SELECT * FROM corporate.select_corporate_portal_sub_users_all_by_org(?)";
		Connection conn = con;
		try (PreparedStatement pstmt = conn.prepareStatement(SQL)) {
			...
			while (rs.next()) {
				...
				result = rs.getString("select_corporate_portal_sub_users_all_by_org");
			}
		} catch (SQLException e) {
			System.out.println(e.getMessage());
		} finally {
	...
	public String select_corporate_portal_sub_users_add(String json_request) {
		String result = null;
		String SQL = "SELECT * FROM corporate.select_corporate_portal_sub_users_add(?)";
		Connection conn = con;
		try (PreparedStatement pstmt = conn.prepareStatement(SQL)) {
			pstmt.setString(1, json_request);
			ResultSet rs = pstmt.executeQuery();
			while (rs.next()) {
				...
				result = rs.getString("select_corporate_portal_sub_users_add");
			}
		} catch (SQLException e) {
			System.out.println(e.getMessage());
		} finally {
	...
	public String select_corporate_portal_sub_users_delete(int id) {
		// System.out.println(id);
		String result = null;
		String SQL = "SELECT * FROM corporate.select_corporate_portal_sub_users_delete(?)";
		Connection conn = con;
		try (PreparedStatement pstmt = conn.prepareStatement(SQL)) {
			pstmt.setInt(1, id);
			ResultSet rs = pstmt.executeQuery();
			while (rs.next()) {
				...
				result = rs.getString("select_corporate_portal_sub_users_delete");
			}
		} catch (SQLException e) {
			System.out.println(e.getMessage());
		} finally {
	...
	public String select_corporate_portal_sub_users_for_login(String json_request) throws JSONException {
		String result = null;
		...
		String SQL = "SELECT * FROM corporate.select_corporate_portal_sub_users_for_login(?,?)";
		Connection conn = con;
		try (PreparedStatement pstmt = conn.prepareStatement(SQL)) {
			pstmt.setString(1, ws_user_name);
			pstmt.setString(2, ws_password);

			// System.out.println(ws_user_name);
			// System.out.println(ws_password);
			ResultSet rs = pstmt.executeQuery();
			while (rs.next()) {
				// System.out.println(rs.getString("select_user_for_login"));
				result = rs.getString("select_corporate_portal_sub_users_for_login");
			}
		} catch (SQLException e) {
			System.out.println(e.getMessage());
		} finally {
